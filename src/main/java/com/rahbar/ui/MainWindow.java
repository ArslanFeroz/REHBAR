...
/**
 * MainWindow  —  builds and owns the RAHBAR desktop application window.
 *
 * Window: 960×620, StageStyle.UNDECORATED, not resizable.
 * Theme applied via ThemeManager on first build.
 */
public class MainWindow {
    ...
    private void centerOnScreen() {
        ...
        stage.setX((screen.getWidth()  - WINDOW_WIDTH)  / 2.0);
        stage.setY((screen.getHeight() - WINDOW_HEIGHT) / 2.0);
    }
}